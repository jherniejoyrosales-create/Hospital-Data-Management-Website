...
import logoImage from '../../hospital-logo.png.jpg';
...
export default function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (login(username, password)) {
      ...
      toast.error('Invalid credentials. Try: admin, doctor, or staff');
    }
  };
        ...
        <Card className="shadow-xl border-2 border-slate-300">
          <CardHeader className="space-y-1 text-center bg-gradient-to-br from-slate-800 to-blue-950 text-white rounded-t-lg pb-8">
            <div className="flex justify-center mb-4">
              <div className="w-24 h-24 rounded-lg flex items-center justify-center shadow-lg p-2">
                <img src={logoImage} alt="Hospital Logo" className="w-full h-full object-contain" />
              </div>
            </div>
          ...
          <CardContent className="pt-6">
            ...
            <div className="mt-6 pt-6 border-t">
              ...
              <div className="space-y-1 text-xs text-gray-500">
                <p><span className="font-medium text-slate-700">Admin:</span> username: admin</p>
                <p><span className="font-medium text-slate-700">Doctor:</span> username: doctor</p>
                <p><span className="font-medium text-slate-700">Staff:</span> username: staff</p>
                <p className="mt-2 text-gray-400">Password: any value</p>
              </div>
            </div>
          </CardContent>
        </Card>
